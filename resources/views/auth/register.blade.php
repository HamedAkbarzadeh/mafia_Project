<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                <x-jet-label for="name" class="float-right mb-3" value="{{ __('نام و نام خانوادگی') }}" />
            ...
            <div class="mt-4">
                <x-jet-label for="password_confirmation" class="float-right mb-3" value="{{ __('تکرار پسورد') }}" />
