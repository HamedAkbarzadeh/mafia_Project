  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{ route('admin.event.store') }}" id="form" method="POST" enctype="multipart/form-data">
                    @csrf
                    <section class="row">
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="type_game" id="type_game" class="form-control form-control-sm">
                                    ...
                                    <option value="0" @if (old('type_game') == 0) selected @endif>کلاسیک</option>
                                    <option value="1" @if (old('type_game') == 1) selected @endif>مدرن</option> 
                                    <option value="2" @if (old('type_game') == 2) selected @endif>ور ولف</option> 
                                </select>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="pay_citizen_win" value="{{ old('pay_citizen_win') }}" type="text" class="form-control form-control-sm">
                                @component('admin.components.error')
                                pay_citizen_win
                                @endcomponent 
                            </div> 
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="pay_mafia_win" value="{{ old('pay_mafia_win') }}" type="text" class="form-control form-control-sm">
                                @component('admin.components.error')
                                pay_mafia_win
                                @endcomponent 
                            </div> 
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="pay_independent_win" value="{{ old('pay_independent_win') }}" type="text" class="form-control form-control-sm">
                                @component('admin.components.error')
                                pay_independent_win
                                @endcomponent 
                            </div> 
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" id="published_at" class="d-none form-control form-control-sm" value="{{ old('start_date')}}">
                                <input type="text" id="published_at_view" class="form-control form-control-sm" value="{{ old('start_date')}}">
                                @component('admin.components.error')
                                start_date
                                @endcomponent 
                            </div> 
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="amount_of_players" id="amount_of_players" class="form-control form-control-sm">
                                    ...
                                    @for ($i = 8 ; $i < 31 ; $i++)
                                    <option value="{{ $i }}" @if (old('amount_of_players') == $i) selected @endif>نفره {{ $i }}</option> 
                                    @endfor
                                </select>    
                                @component('admin.components.error')
                                amount_of_players
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input name="god_names" value="{{ old('god_names') }}" type="text" class="form-control form-control-sm">
                                @component('admin.components.error')
                                god_names
                                @endcomponent 
                            </div> 
                        ...
                        {{-- <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="image" id="image" class="form-control form-control-sm"  value="{{ old('image')}}">
                                @component('admin.components.error')
                                image
                                @endcomponent 
                            </div> 
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="game_status" id="game_status" class="form-control form-control-sm" value="{{ old('game_status')}}">
                                    <option value="0" @if (old('game_status') == 0) selected @endif>تمام نشده</option>
                                    <option value="1" @if (old('game_status') == 1) selected @endif>تمام شده</option> 
                                </select>
                                @component('admin.components.error')
                                game_status
                                @endcomponent 
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select name="complation_status" id="game_status" class="form-control form-control-sm" value="{{ old('complation_status')}}">
                                    <option value="0" @if (old('complation_status') == 0) selected @endif> تکمیل نشده</option>
                                    <option value="1" @if (old('complation_status') == 1) selected @endif>تکیمل شده</option> 
                                </select>
                                @component('admin.components.error')
                                complation_status
                                @endcomponent 
                        ...
                        <section class="col-12 col-md-6 d-none" id="side_win">
                            <div class="form-group">
                                <label for="side_win">ساید برنده شده</label>
                                <select name="side_win" class="form-control form-control-sm" value="{{ old('side_win')}}">
                                    <option value="0" @if (old('side_win') == 0) selected @endif>شهروند</option>
                                    <option value="1" @if (old('side_win') == 1) selected @endif>مافیا</option> 
                                    <option value="2" @if (old('side_win') == 2) selected @endif>مستقل</option> 
                                </select>
                                @component('admin.components.error')
                                side_win
                                @endcomponent 
                        ...
                        <section class="col-12">
                            ...
                            <option value="{{ $mafia->id }}" @if (old('mafiaRole') == $mafia->id) selected @endif>{{ $mafia->name }}</option>
                            @empty
                        ...
                        <section class="col-12">
                            ...
                            <option value="{{ $citizen->id }}" @if (old('citizenRole') == $citizen->id) selected @endif>{{ $citizen->name }}</option>
                            @empty
                        ...
                        <section class="col-12">
                            ...
                            <option value="{{ $independent->id }}"  @if (old('independentRole') == $independent->id) selected @endif>{{ $independent->name }}</option>
                            @empty
                        ...
                        <section class="col-12 col-md-6 mt-4">
                            <div class="form-group">
                                ...
                                <br>
                                <input name="vip_game" value="1" type="checkbox" @if (old('vip_game') == 1) checked @endif>
                                @component('admin.components.error')
                                vip_game
                                @endcomponent 
                            </div> 
