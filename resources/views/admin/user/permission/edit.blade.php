...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page"> بروز رسانی دسترسی</li>
    </ol>
  </nav>
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name', $permission->name) }}" id="name" class="form-control form-control-sm">
                        ...
                        <section class="col-12 col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" name="description"  value="{{ old('description', $permission->description) }}" id="description" class="form-control form-control-sm">
                                @component('admin.components.error')
                                description
                                @endcomponent 
                            </div>
