...
return [
    ...
    */
    'attributes' => [
        ...
        'price_increase'        => 'قیمت افزایش یافته',
        ...
        'recipient_last_name' => 'فامیل گیرنده',
        'no' => 'پلاک',
        'unit' => 'واحد ',
        'copan_id' => 'کد تخفیف',
        ...
        'type_game' => 'نوع بازی',
        'pay_win_team' => 'جایزه تیم برنده',
        'amount_of_players' => 'تعداد نفرات',
        'god_names' => 'نام گاد',
        'mafiaRole' => 'نقش های مافیا',
        'citizenRole' => 'نقش های شهروند',
        'independentRole' => 'نقش های مستقل',
        'vip_game' => 'vip',
        'user_role' => 'نقش بازیکن',
        'role_game' => 'ساید بازیکن',
        'result_game' => 'نتیجه بازی',
    ],  
];