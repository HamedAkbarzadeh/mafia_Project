...
class Product extends Model
{
    ...
    protected $fillable = ['name', 'introduction', 'slug', 'image', 'weight', 'length', 'width', 'height', 'price', 'status', 'marketable', 'tags', 'sold_number', 'forzen_number', 'marketable_number', 'brand_id', 'category_id', 'published_id'];
